...
export default function ProductsContainer(props)
{
  ...
  if(!props.all && width >= 1200)
  {
    ...
    return(
      ...
      <div className='text-2xl font-semibold w-fit ml-14 mr-auto mt-[1%] mb-[2%] before:bg-red-600 '>{props.title}</div>
     <div className="w-[80%]  ml-14  overflow-hidden flex">
     ...
     <div className="mr-20 p-3 bg-green-600 mt-4" onClick={(e)=>
    {
