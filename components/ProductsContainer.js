...
export default function ProductsContainer(props)
{
  ...
  if(!props.all && width >= 1200)
  {
    ...
    return(<div className="flex flex-col ml-[8%]">
       <div className='text-2xl font-semibold w-fit    mr-auto mt-[1%] mb-[2%] before:bg-red-600 before:w-20 before:h-20'>{props.title}</div>
      <div className="flex gap-9 w-[80% overflow-hidden">
