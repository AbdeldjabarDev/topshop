...
export default function PurchaseSuccss()
{
    let router= useRouter();
    let dark = useSelector((state)=> state.products.dark);
    return (<div className="flex flex-col w-full min-h-screen h-fit" style={{backgroundColor : dark == true ? "#000d1a":"white",color:dark == true ? "white":"black"}}>
    <Nav></Nav>
